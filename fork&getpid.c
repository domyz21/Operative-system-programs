...
int main(void) {
    ...
    if(pid > 0){ //siamo nel padre
        ...
        //stampi il valore di pid (fork) se vuoi stampare il pid del parde
        //getpid() per ottenere il pid (del padre)
        ...
        //getpid() per ottenere il pid (del figlio)
        //getppid() per ottenere il pid (del padre)
